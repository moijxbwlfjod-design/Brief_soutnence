        ...
        add_staff_btn.addEventListener("click", (e)=>{
           ...
           main.insertAdjacentHTML('beforeend', `
                ...
                <div id="popup" class="popup w-[25rem] h-[100vh] bg-[white] rounded-[20px] fixed top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 py-[1rem] px-[0.6rem] flex flex-col gap-[10px] overflow-y-auto">
                    <div id="staff_name" class="staff_name">
                        <label for="staff_name">Staff Name:</label>
                        <input type="text" id="staff_name" placeholder="mohamed" class="border border-gray-300 focus:outline-none focus:border-blue-500 rounded-[8px]">
                        <span id="staff_name_error"></span>
                    </div>

                    <div id="staff_role" class="staff_role">
                        <label for="staff_role">Staff Role:</label>
                        <select name="staff_role" id="staff_role" class="border border-gray-300 focus:outline-none focus:border-blue-500 rounded-[8px]">
                    ...
                    <div id="staff_photo" class="staff_photo">
                        <div class="staff_photo_url">
                            <label for="staff_photo">Photo URL:</label>
                            <input type="text" id="staff_photo_input" placeholder="https://......"  class="border border-gray-300 focus:outline-none focus:border-blue-500 rounded-[8px]">
                        </div>
                    ...
                    <div id="staff_email" class="staff_email">
                        <label for="staff_email">Staff Email:</label>
                        <input type="text" id="staff_email" placeholder="mohamed@gmail.com" class="border border-gray-300 focus:outline-none focus:border-blue-500 rounded-[8px]">
                        <span id="staff_email_error"></span>
                    </div>

                    <div id="staff_tel" class="staff_tel">
                        <label for="staff_tel">Staff Phone:</label>
                        <input type="text" id="staff_tel" placeholder="0612345678" class="border border-gray-300 focus:outline-none focus:border-blue-500 rounded-[8px]">
                    ...
                    document.getElementById("non_used_staffs").insertAdjacentHTML('beforeend', `
                        <div class="non_used_card w-[90%] h-[auto] bg-[white] px-[2px] rounded-[8px]">
                            ...
                            <div class="non_used_btns flex flex-wrap gap-[5px] px-[2px] py-[7px]">
                                <button class="assing_btn bg-[#007BFF] text-[white] py-[0.2rem] flex-1 px-[auto] rounded-[8px]">Assing</button>
                                <button class="assing_btn bg-yellow-500 text-[white] py-[0.2rem] flex-1 px-[auto] rounded-[8px]">Edit</button>
                                <button class="remove_btn bg-red-400 text-[white] py-[0.2rem] flex-1 px-[auto] rounded-[8px]">Remove</button>
                            </div>
                        </div>
                    `);
                }
